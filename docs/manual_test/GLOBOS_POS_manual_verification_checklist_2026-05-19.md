...
```text
[REDACTED — rotate via Supabase Auth dashboard]
```
...
|---|---|---|---|
| Waiter | `waiter@globos.test` | `[REDACTED]` | 웨이터 테이블/대시보드 POS |
| Kitchen | `kitchen@globos.test` | `[REDACTED]` | 주방 티켓 큐 |
| Cashier | `cashier@globos.test` | `[REDACTED]` | 계산/결제 큐 |
| Store admin | `admin@globos.test` | `[REDACTED]` | 매장 관리자 운영 화면 |
| Super admin | `superadmin@globos.test` | `[REDACTED]` | 슈퍼 관리자 화면 |
| Full validation | `pos.validation.codex@globos.test` | `[REDACTED]` | 광범위 검증용 접근 화면 |
...
|---|---|---|---|
| Office store | `office.store@globos.vn` | `[REDACTED]` | POS 범위 밖 처리 |
| Office brand KN | `office.brand.kn@globos.vn` | `[REDACTED]` | POS 범위 밖 처리 |
| Office brand MK | `office.brand.mk@globos.vn` | `[REDACTED]` | POS 범위 밖 처리 |
| Office staff | `office.staff@globos.vn` | `[REDACTED]` | POS 범위 밖 처리 |
| Office super | `office.super@globos.vn` | `[REDACTED]` | POS 범위 밖 처리 |
