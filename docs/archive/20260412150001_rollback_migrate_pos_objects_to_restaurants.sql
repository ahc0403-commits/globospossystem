-- ============================================================================
-- Manual rollback: restore POS objects to restaurant-path definitions
-- Safety-only manual rollback for migrate stage. Not for normal migration chain.
-- ============================================================================

BEGIN;

-- Restore function / RPC bodies
...
-- Drop store-path helper views added by migrate

DROP VIEW IF EXISTS public.daily_closings_store_bridge;

DROP VIEW IF EXISTS public.office_payroll_reviews_store_bridge;

DROP VIEW IF EXISTS public.qc_followups_store_bridge;

DROP VIEW IF EXISTS public.delivery_settlements_store_bridge;

DROP VIEW IF EXISTS public.payroll_records_store_bridge;

DROP VIEW IF EXISTS public.staff_wage_configs_store_bridge;

DROP VIEW IF EXISTS public.qc_checks_store_bridge;

DROP VIEW IF EXISTS public.qc_templates_store_bridge;

DROP VIEW IF EXISTS public.inventory_physical_counts_store_bridge;

DROP VIEW IF EXISTS public.inventory_transactions_store_bridge;

DROP VIEW IF EXISTS public.menu_recipes_store_bridge;

DROP VIEW IF EXISTS public.external_sales_store_bridge;

DROP VIEW IF EXISTS public.inventory_items_store_bridge;

DROP VIEW IF EXISTS public.attendance_logs_store_bridge;

DROP VIEW IF EXISTS public.payments_store_bridge;

DROP VIEW IF EXISTS public.order_items_store_bridge;

DROP VIEW IF EXISTS public.orders_store_bridge;

DROP VIEW IF EXISTS public.menu_items_store_bridge;

DROP VIEW IF EXISTS public.menu_categories_store_bridge;

DROP VIEW IF EXISTS public.tables_store_bridge;

DROP VIEW IF EXISTS public.users_store_bridge;

DROP VIEW IF EXISTS public.store_settings;
