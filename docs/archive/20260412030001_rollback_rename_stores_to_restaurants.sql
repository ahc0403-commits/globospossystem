-- ============================================================================
-- ROLLBACK: stores -> restaurants (reverse of 20260412030000)
-- THIS FILE IS NOT APPLIED DURING NORMAL OPERATION.
-- Apply manually only if the forward migration causes post-deployment issues.
-- Must be applied within 2 minutes of detecting failure.
-- ============================================================================

BEGIN;

-- ============================================================================
-- SECTION 1: Drop compatibility alias view (depends on public_store_profiles)
-- ============================================================================

DROP VIEW IF EXISTS public_restaurant_profiles CASCADE;

-- ============================================================================
-- SECTION 2: Drop all views that reference renamed tables
-- ============================================================================

DROP VIEW IF EXISTS public_store_profiles CASCADE;
...
-- ============================================================================
-- SECTION 3: Drop all RLS policies on renamed tables
-- ============================================================================

-- stores (will become restaurants)
...
-- menu_recipes
DROP POLICY IF EXISTS "store_isolation" ON public.menu_recipes;

-- inventory_transactions
DROP POLICY IF EXISTS "store_isolation" ON public.inventory_transactions;

-- inventory_physical_counts
DROP POLICY IF EXISTS "store_isolation" ON public.inventory_physical_counts;
...
-- qc_checks
DROP POLICY IF EXISTS "store_isolation" ON public.qc_checks;

-- qc_followups
DROP POLICY IF EXISTS qc_followups_store_isolation ON public.qc_followups;

-- staff_wage_configs
DROP POLICY IF EXISTS "store_isolation" ON public.staff_wage_configs;

-- payroll_records
DROP POLICY IF EXISTS "store_isolation" ON public.payroll_records;

-- store_settings (will become restaurant_settings)
...
-- daily_closings (policy is on the view-based daily_closings table, handled via functions)

-- ============================================================================
-- SECTION 4: Recreate RLS helper function — get_user_store_id -> get_user_restaurant_id
-- ============================================================================
...
-- ============================================================================
-- SECTION 5: Drop renamed functions and recreate with original names
-- ============================================================================

-- Drop store-named functions created by forward migration
DROP FUNCTION IF EXISTS public.require_admin_actor_for_store(UUID);
DROP FUNCTION IF EXISTS public.admin_create_store(TEXT, TEXT, TEXT, TEXT, DECIMAL, UUID, TEXT);
DROP FUNCTION IF EXISTS public.admin_update_store(UUID, TEXT, TEXT, TEXT, TEXT, DECIMAL, UUID, TEXT);
DROP FUNCTION IF EXISTS public.admin_deactivate_store(UUID);
DROP FUNCTION IF EXISTS public.admin_update_store_settings(UUID, TEXT, TEXT, TEXT, DECIMAL);
...
-- ============================================================================
-- SECTION 6: Rename constraints/indexes back
-- ============================================================================

ALTER INDEX IF EXISTS tables_store_id_table_number_key RENAME TO tables_restaurant_id_table_number_key;
ALTER INDEX IF EXISTS unique_settlement_period_store RENAME TO unique_settlement_period;
ALTER TABLE public.stores RENAME CONSTRAINT stores_store_type_check TO restaurants_store_type_check;
ALTER INDEX IF EXISTS idx_users_store RENAME TO idx_users_restaurant;
ALTER INDEX IF EXISTS idx_tables_store RENAME TO idx_tables_restaurant;
ALTER INDEX IF EXISTS idx_menu_items_store RENAME TO idx_menu_items_restaurant;
ALTER INDEX IF EXISTS idx_orders_store RENAME TO idx_orders_restaurant;
ALTER INDEX IF EXISTS idx_orders_store_status RENAME TO idx_orders_status;
ALTER INDEX IF EXISTS idx_payments_store RENAME TO idx_payments_restaurant;
ALTER INDEX IF EXISTS idx_external_sales_store RENAME TO idx_external_sales_restaurant;
ALTER INDEX IF EXISTS idx_fingerprint_templates_store RENAME TO idx_fingerprint_templates_restaurant;
ALTER INDEX IF EXISTS idx_stores_store_type RENAME TO idx_restaurants_store_type;
ALTER INDEX IF EXISTS idx_stores_brand_store_type RENAME TO idx_restaurants_brand_store_type;
ALTER INDEX IF EXISTS idx_stores_brand_id RENAME TO idx_restaurants_brand_id;
ALTER INDEX IF EXISTS idx_office_payroll_reviews_store RENAME TO idx_office_payroll_reviews_restaurant;
ALTER INDEX IF EXISTS idx_daily_closings_store_date RENAME TO idx_daily_closings_restaurant_date;
ALTER INDEX IF EXISTS idx_inventory_items_store_name_ci RENAME TO idx_inventory_items_restaurant_name_ci;
ALTER INDEX IF EXISTS unique_daily_closing_store RENAME TO unique_daily_closing;

-- ============================================================================
-- SECTION 7: Rename columns back (store_id -> restaurant_id)
-- ============================================================================

ALTER TABLE public.store_settings RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.users RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.tables RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.menu_categories RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.menu_items RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.orders RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.order_items RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.payments RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.attendance_logs RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.inventory_items RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.external_sales RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.menu_recipes RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.inventory_transactions RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.inventory_physical_counts RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.qc_templates RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.qc_checks RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.staff_wage_configs RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.payroll_records RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.fingerprint_templates RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.delivery_settlements RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.qc_followups RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.office_payroll_reviews RENAME COLUMN store_id TO restaurant_id;
ALTER TABLE public.daily_closings RENAME COLUMN store_id TO restaurant_id;

-- ============================================================================
-- SECTION 8: Rename tables back (stores -> restaurants, store_settings -> restaurant_settings)
-- ============================================================================

ALTER TABLE public.stores RENAME TO restaurants;
ALTER TABLE public.store_settings RENAME TO restaurant_settings;

-- ============================================================================
-- SECTION 9: Recreate all RLS policies with restaurant_id references
-- ============================================================================

-- ────────────────────────────────────────────
-- restaurants (was stores)
-- ────────────────────────────────────────────
...
-- ────────────────────────────────────────────
-- restaurant_settings (was store_settings)
-- ────────────────────────────────────────────
...
-- ============================================================================
-- SECTION 10: Recreate all views with restaurants/restaurant_id references
-- ============================================================================
...
-- ============================================================================
-- SECTION 11: Recreate functions with restaurant_id bodies (kept same name)
-- ============================================================================
...
BEGIN
  ...
  WHERE al.entity_type = ANY (
      ARRAY[
        'restaurants', 'stores', 'tables', 'menu_categories', 'menu_items',
        'orders', 'order_items', 'payments'
      ]
    )
    AND (
      NULLIF(al.details ->> 'restaurant_id', '')::UUID = p_restaurant_id
      OR NULLIF(al.details ->> 'store_id', '')::UUID = p_restaurant_id
      OR (
        al.entity_type IN ('restaurants', 'stores')
...
BEGIN
  ...
  SELECT
    ...
    v_recipe.restaurant_id AS store_id,
...
BEGIN
  ...
  SELECT
    ...
    v_log.restaurant_id AS store_id,
    v_log.user_id,
...
BEGIN
  ...
  ELSE
    IF p_restaurant_id IS NULL THEN RAISE EXCEPTION 'QC_TEMPLATE_STORE_REQUIRED'; END IF;
  ...
  INSERT INTO public.qc_templates (
    restaurant_id, category, criteria_text, criteria_photo_url,
...
BEGIN
  ...
  IF array_length(v_changed_fields, 1) > 0 THEN
    ...
    VALUES (
      ...
      jsonb_build_object(
        'restaurant_id', v_updated.restaurant_id, 'is_global', v_updated.is_global,
        'changed_fields', to_jsonb(v_changed_fields),
...
BEGIN
  ...
  VALUES (
    ...
    jsonb_build_object('restaurant_id', v_updated.restaurant_id, 'is_global', v_updated.is_global)
  );
...
BEGIN
  ...
  IF v_actor.role <> 'super_admin' AND v_actor.restaurant_id <> p_restaurant_id THEN RAISE EXCEPTION 'QC_CHECK_READ_FORBIDDEN'; END IF;
  ...
  RETURN QUERY
  SELECT
    qc.id AS check_id, qc.restaurant_id AS store_id, qc.template_id, qc.check_date,
...
CREATE OR REPLACE FUNCTION public.upsert_qc_check(
  p_restaurant_id UUID, p_template_id UUID, p_check_date DATE,
...
BEGIN
  ...
  IF v_actor.role <> 'super_admin' AND v_actor.restaurant_id <> p_restaurant_id THEN RAISE EXCEPTION 'QC_CHECK_WRITE_FORBIDDEN'; END IF;
  ...
  INSERT INTO public.qc_checks (
    restaurant_id, template_id, check_date, checked_by, result, evidence_photo_url, note
  ) VALUES (
    p_restaurant_id, p_template_id, p_check_date, v_checked_by, p_result, v_photo, v_note
  )
  ON CONFLICT (template_id, check_date)
  DO UPDATE SET
    restaurant_id = EXCLUDED.restaurant_id, checked_by = EXCLUDED.checked_by,
  ...
  VALUES (
    ...
    jsonb_build_object(
      'restaurant_id', p_restaurant_id, 'template_id', p_template_id,
...
BEGIN
  ...
  IF v_actor.role <> 'super_admin' AND v_actor.restaurant_id <> p_restaurant_id THEN RAISE EXCEPTION 'QC_FOLLOWUP_WRITE_FORBIDDEN'; END IF;

  SELECT * INTO v_check FROM public.qc_checks WHERE id = p_source_check_id AND restaurant_id = p_restaurant_id;
  ...
  INSERT INTO public.qc_followups (
    restaurant_id, source_check_id, status, assigned_to_name, created_by
  ) VALUES (
  ...
  VALUES (
    ...
    jsonb_build_object('restaurant_id', p_restaurant_id, 'source_check_id', p_source_check_id,
...
CREATE OR REPLACE FUNCTION public.update_qc_followup_status(
  p_followup_id UUID, p_restaurant_id UUID,
...
BEGIN
  ...
  SELECT * INTO v_existing FROM public.qc_followups WHERE id = p_followup_id AND restaurant_id = p_restaurant_id FOR UPDATE;
  ...
  VALUES (
    ...
    jsonb_build_object('restaurant_id', p_restaurant_id, 'old_status', v_existing.status,
...
BEGIN
  ...
  IF v_actor.role <> 'super_admin' AND v_actor.restaurant_id <> p_restaurant_id THEN RAISE EXCEPTION 'QC_FOLLOWUP_READ_FORBIDDEN'; END IF;

  RETURN QUERY
  SELECT
    f.id AS followup_id, f.restaurant_id AS store_id, f.source_check_id, f.status,
...
BEGIN
  ...
  IF v_actor.role <> 'super_admin' AND v_actor.restaurant_id <> p_restaurant_id THEN RAISE EXCEPTION 'QC_ANALYTICS_FORBIDDEN'; END IF;
  ...
  SELECT
    ...
    (SELECT COUNT(*) FROM public.qc_templates qt
     WHERE qt.is_active = TRUE AND (qt.is_global = TRUE OR qt.restaurant_id = p_restaurant_id))::BIGINT AS template_count,
    CASE
      WHEN (SELECT COUNT(*) FROM public.qc_templates qt
            WHERE qt.is_active = TRUE AND (qt.is_global = TRUE OR qt.restaurant_id = p_restaurant_id)) = 0
      THEN 0::NUMERIC
      ELSE ROUND(COUNT(*)::NUMERIC / ((SELECT COUNT(*) FROM public.qc_templates qt
            WHERE qt.is_active = TRUE AND (qt.is_global = TRUE OR qt.restaurant_id = p_restaurant_id)) * v_days)::NUMERIC * 100, 1)
    END AS coverage,
    (SELECT COUNT(*) FROM public.qc_followups f
     WHERE f.restaurant_id = p_restaurant_id AND f.status IN ('open', 'in_progress'))::BIGINT AS open_followups
  FROM public.qc_checks qc
  WHERE qc.restaurant_id = p_restaurant_id AND qc.check_date >= p_from AND qc.check_date <= p_to;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER
SET search_path = public, auth;
...
BEGIN
  ...
  IF p_user_id IS NULL OR p_restaurant_id IS NULL THEN RAISE EXCEPTION 'STAFF_ACCOUNT_UPDATE_INVALID'; END IF;
  IF v_actor.role <> 'super_admin' AND v_actor.restaurant_id <> p_restaurant_id THEN RAISE EXCEPTION 'STAFF_ACCOUNT_UPDATE_FORBIDDEN'; END IF;

  SELECT * INTO v_target FROM public.users WHERE id = p_user_id AND restaurant_id = p_restaurant_id FOR UPDATE;
  ...
  IF array_length(v_changed_fields, 1) > 0 THEN
    ...
    VALUES (
      ...
      jsonb_build_object('restaurant_id', v_updated.restaurant_id,
        'changed_fields', to_jsonb(v_changed_fields),
        'old_values', v_old_values, 'new_values', v_new_values)
    );
  END IF;
...
DECLARE
  ...
  v_full_name TEXT := NULLIF(btrim(COALESCE(p_full_name, '')), '');
BEGIN
  IF p_restaurant_id IS NULL THEN RAISE EXCEPTION 'ONBOARDING_STORE_REQUIRED'; END IF;
  IF v_full_name IS NULL THEN RAISE EXCEPTION 'USER_FULL_NAME_REQUIRED'; END IF;
  ...
  UPDATE public.users
  SET restaurant_id = p_restaurant_id, full_name = v_full_name, role = p_role
  WHERE id = v_actor.id
  RETURNING * INTO v_updated;
  ...
  VALUES (
    ...
    jsonb_build_object('restaurant_id', p_restaurant_id, 'new_role', p_role)
  );
...
-- ============================================================================
-- SECTION 12: Trigger function updates
-- ============================================================================

-- on_payroll_store_submitted: references stores -> restaurants, store_id -> restaurant_id
...
-- ============================================================================
-- SECTION 13: Table comments update
-- ============================================================================

COMMENT ON TABLE restaurants IS 'F&B restaurant tenant';
COMMENT ON TABLE restaurant_settings IS 'Per-restaurant settings';
