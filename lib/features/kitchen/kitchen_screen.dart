...
class KitchenScreen extends ConsumerStatefulWidget {
  const KitchenScreen({super.key, this.autoStartPrinting = false});

  final bool autoStartPrinting;
...
class _KitchenScreenState extends ConsumerState<KitchenScreen> {
  ...
  final PrintJobAgentService _printJobAgent = PrintJobAgentService();
  String? _printingStoreId;
  ...
  void _ensureLoaded(String? storeId) {
    ...
    if (widget.autoStartPrinting &&
        _printJobAgent.isSupported &&
        _printingStoreId != storeId) {
      _printingStoreId = storeId;
