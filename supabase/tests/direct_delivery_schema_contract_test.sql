...
('direct_order_quotes','delivery_payment_mode','text',true,true),
...
('direct_order_financials','delivery_payment_mode','text',true,true),
...
('direct_order_dispatches','delivery_payment_mode','text',true,true),
...
('public.direct_order_staff_quote_with_payment_mode(uuid,uuid,numeric,text,text)',true,true),
...
('public.direct_order_staff_sepay_candidates_v2(uuid,uuid)',true,true),
