...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'scope', jsonb_build_object(
      ...
      'include_combos', p_include_combos,
...
COMMENT ON FUNCTION public.get_store_menu_sales_analytics(
  ...
  'Returns store-scoped POS menu analytics with combo rows identified from immutable order-item composition snapshots and an explicit include/exclude combo scope.';
