...
--    (MISA_MEINVOICE_CLIENT_SECRET) and never lands in this table.
...
COMMENT ON COLUMN public.meinvoice_tax_entity_config.app_id IS
  'MISA Developer Portal ClientID for the registered GLOBOS POS app. Non-secret; the paired ClientSecret lives only in Edge Function env (MISA_MEINVOICE_CLIENT_SECRET).';
