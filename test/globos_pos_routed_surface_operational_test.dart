...
final _routeSurfaces = <_RouteSurface>[
  ...
  _RouteSurface(
    ...
    label: (l10n, _) => l10n.attendanceAndroidTabletRequired,
  ),
  _RouteSurface(
    location: '/qc-check',
    pattern: '/qc-check',
  ...
  _RouteSurface(
    ...
    label: (l10n, _) => l10n.photoOpsPriorityQueueTitle,
  ),
  _RouteSurface(
...
void main() {
  ...
  testWidgets(
    'all seventeen approved routes render localized focusable touch surfaces',
    (tester) async {
      final semantics = tester.ensureSemantics();
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      expect(_routeSurfaces, hasLength(17));
  ...
  testWidgets(
    'all seventeen routes preserve every touch target in offline state',
    (tester) async {
      final semantics = tester.ensureSemantics();
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
