...
const _routeStateCoverage = <_RouteStateCoverage>[
  ...
  _RouteStateCoverage(
    ...
    operationalTest: 'test/remaining_route_operational_state_test.dart',
    stateMarkers: [
      'AttendanceKioskState(isLoading: true)',
      'Stream.value(false)',
      "'Clock In'",
    ],
  ),
  ...
  _RouteStateCoverage(
    ...
    stateMarkers: [
      'all four table dialog entrypoints',
      'all three menu dialog entrypoints',
...
void main() {
  test('all 17 routes map to applicable operational state tests', () {
    expect(_routeStateCoverage, hasLength(17));
    expect(
