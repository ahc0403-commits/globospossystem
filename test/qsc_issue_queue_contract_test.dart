...
void main() {
  test(
    'qsc issue queue first slice stays read-only and depends on tracked view',
    () {
      ...
      expect(screen, contains('_queueMetricCard('));
      expect(screen, contains('_queueSupportRow('));
      expect(screen, contains('_queueFocusCopy('));
      expect(screen, contains('_queueFilterContext('));
      expect(screen, contains('_queueRowNarrative('));
      expect(screen, contains('_issueSubmissionColor('));
      expect(screen, contains('_issuePhotoColor('));
