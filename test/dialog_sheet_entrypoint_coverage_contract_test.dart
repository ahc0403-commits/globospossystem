...
const _coverage = <_OperationalCoverage>[
  ...
  _OperationalCoverage(
    ...
    markers: [
      ...
      'cashier_bank_transfer_qr_dialog',
  ...
  _OperationalCoverage(
    ...
    markers: ['qr_confirm_dialog', 'qr_combo_drink_dialog_'],
  ),
  _OperationalCoverage(
    ...
    markers: [
      ...
      'inventory_ingredient_excel_preview_dialog',
  ...
  _OperationalCoverage(
    ...
    markers: ['photo_inventory_item_dialog', 'photo_inventory_history_dialog'],
  ),
  _OperationalCoverage(
  ...
  _OperationalCoverage(
    source: 'lib/features/admin/tabs/reports_tab.dart',
    directCalls: 2,
    test: 'test/reports_operational_attention_contract_test.dart',
    markers: ['reports_issue_detail_list', 'daily_closing_cash_dialog'],
  ),
  _OperationalCoverage(
    source: 'lib/features/report/bm_menu_exception_history.dart',
    directCalls: 2,
    test: 'test/bm_menu_exception_history_contract_test.dart',
    markers: ['bm_menu_history_detail', 'bm_original_order_detail'],
  ),
  _OperationalCoverage(
  ...
  _OperationalCoverage(
    ...
    markers: ['direct_customer_my_orders'],
  ),
  _OperationalCoverage(
    source:
    ...
    directCalls: 1,
    test: 'test/emergency_fulfillment_responsive_test.dart',
    markers: ['kitchen_checket_handoff_sheet'],
  ),
  _OperationalCoverage(
    source:
        'lib/features/admin/widgets/paperless_menu_timing_detail_sheet.dart',
    directCalls: 1,
    test: 'test/paperless_operations_dashboard_test.dart',
    markers: ['paperless_menu_timing_detail_sheet'],
  ),
];
...
void main() {
  test('all 128 dialog and sheet entrypoints map to operational tests', () {
    ...
    expect(_coverage.fold<int>(0, (sum, item) => sum + item.directCalls), 127);
    expect(
