...
void main() {
  ...
  test('einvoice screen exposes the compact pending exception queue only', () {
    final source = readRepoFile('lib/features/admin/tabs/einvoice_tab.dart');
    ...
    expect(visibleBuild, isNot(contains("Key('misa_pending_excel_download')")));
    expect(visibleBuild, isNot(contains('_downloadMisaWorkbook')));
