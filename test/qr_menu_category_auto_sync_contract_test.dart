...
void main() {
  test(
    'QR menu mirrors active admin categories and defaults new menus public',
    () {
      ...
      expect(screen, contains('menuSafetyRefreshJitter'));
      expect(
        screen,
  ...
  test('production gate verifies TOP7 and function privileges', () {
    ...
    expect(
      preflight,
      contains('QR_MENU_CATEGORY_AUTO_SYNC_DEPENDENCY_MISSING'),
    );
